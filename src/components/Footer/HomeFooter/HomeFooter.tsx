...
const HomeFooterSection = (props: Props) => {
  return (
    <div className="w-full flex justify-center">
      <div className="w-5/6 flex flex-col-reverse sm:flex-row items-center justify-between py-10">
        <p className="sm:hidden my-5 text-white text-center text-xl">
        ...
        <div className="w-full my-5 flex flex-row sm:flex-col items-center justify-center ">
          <div className="my-5 h-20">
            <img className="w-full h-full" src={logo} alt="logo" />
          </div>
          <p className="hidden sm:block my-5 text-white text-center text-xl">
            © Copyright 2022 Convex Financial{" "}
          </p>

          <div className="sm:hidden w-full flex items-center justify-center my-16 gap-1 sm:gap-10">
            <button className="toolbar_gradient p-2 sm:p-3 flex justify-center items-center h-10 w-10 sm:h-12 sm:w-12 rounded-full">
              <img
        ...
        <div className="hidden sm:flex w-full items-center justify-center my-16 gap-10">
          <button className="toolbar_gradient p-3 flex justify-center items-center h-10 w-10 sm:h-12 sm:w-12 rounded-full">
